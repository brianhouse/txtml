...
class Format_firstname implements Format {

	public function process ($input) {

		$filter = array( "name","names","called","mr","mrs","ms","mister","first","last","call","me","people","this","nice","meet","nickname","friends","friend","best","brother","sister","mother","father","mom","dad" );
		...
		BH_util::log("format [firstname] [$input] -> [$output]");		
		return $output;
